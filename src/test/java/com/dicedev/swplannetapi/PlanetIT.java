package com.dicedev.swplannetapi;

import static com.dicedev.swplannetapi.common.PlanetConstants.ALDERAAN;
...
public class PlanetIT {
    ...
    @Test
    public void getPlanets_ByClimate_ReturnsPlanets() {
    ...
    @Test
    public void getPlanets_ByTerrain_ReturnsPlanets() {
    ...
    public void removePlanet_ReturnsNoContent() {
        ResponseEntity<Void> sut = restTemplate.exchange("/planets/{id}", HttpMethod.DELETE, null, Void.class, TATOOINE.getId());
